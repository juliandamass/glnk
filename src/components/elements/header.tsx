...
const Header = () => {
  return (
    <div className="flex flex-col lg:flex-row items-stretch justify-between gap-4 lg:gap-6">
      <div className="flex items-center justify-between w-full h-full p-2 lg:p-4 bg-white rounded-2xl shadow-sm shadow-gray-100">
      ...
      <div className="flex items-center w-full lg:max-w-[340px] h-full p-2 lg:p-4 bg-white rounded-2xl shadow-sm shadow-gray-100">
        <div className="flex flex-col gap-2">
